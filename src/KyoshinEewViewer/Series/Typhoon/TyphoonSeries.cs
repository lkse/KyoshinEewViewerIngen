...
{
	public static SeriesMeta MetaData { get; } = new(typeof(TyphoonSeries), "typhoon", Localization.LocalizationKey.SeriesTyphoonName, new FAFontIconSource { Glyph = "\xf751", FontFamily = new(Utils.IconFontName) }, false, Localization.LocalizationKey.SeriesTyphoonDescription);
